...
const QueryComponent = ({handleSearchClick, setSearch, setFieldSelect, setLanguageSelect, setGenresSelect, database, fieldSelect}: QueryComponentProps) => {
	const {data: genreData, error: genreError, isPending: genrePending} = useFetch(`http://165.106.10.170:32401/${database}/genres`);
	const {data: languageData, error: languageError, isPending: languagePending} = useFetch(`http://165.106.10.170:32401/${database}/books/languages`);
